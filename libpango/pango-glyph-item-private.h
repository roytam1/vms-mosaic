...
#define _pango_glyph_item_iter_init_start _pan_glyph_item_iter_init_start
...
gboolean _pango_glyph_item_iter_init_end     (PangoGlyphItemIter *iter,
					      PangoGlyphItem     *glyph_item,
					      const char         *text);
#define _pango_glyph_item_iter_next_cluster _pan_glyph_item_iter_next_clust
gboolean _pango_glyph_item_iter_next_cluster (PangoGlyphItemIter *iter);
#define _pango_glyph_item_iter_prev_cluster _pan_glyph_item_iter_prev_clust
