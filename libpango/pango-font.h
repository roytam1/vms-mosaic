...
#define pango_font_description_copy_static pango_font_descript_copy_static
...
void                  pango_font_descriptions_free       (PangoFontDescription       **descs,
							  int                          n_descs);
#define pango_font_description_set_family pango_font_descript_set_family
void                 pango_font_description_set_family        (PangoFontDescription *desc,
							       const char           *family);
#define pango_font_description_set_family_static pango_font_desc_set_fami_static
void                 pango_font_description_set_family_static (PangoFontDescription *desc,
							       const char           *family);
#define pango_font_description_get_family pango_font_descript_get_family
G_CONST_RETURN char *pango_font_description_get_family        (const PangoFontDescription *desc);
#define pango_font_description_set_style pango_font_descript_set_style
void                 pango_font_description_set_style         (PangoFontDescription *desc,
							       PangoStyle            style);
#define pango_font_description_get_style pango_font_descript_get_style
PangoStyle           pango_font_description_get_style         (const PangoFontDescription *desc);
#define pango_font_description_set_variant pango_font_descript_set_vari
void                 pango_font_description_set_variant       (PangoFontDescription *desc,
							       PangoVariant          variant);
#define pango_font_description_get_variant pango_font_descript_get_vari
PangoVariant         pango_font_description_get_variant       (const PangoFontDescription *desc);
#define pango_font_description_set_weight pango_font_descript_set_weight
void                 pango_font_description_set_weight        (PangoFontDescription *desc,
							       PangoWeight           weight);
#define pango_font_description_get_weight pango_font_descript_get_weight
PangoWeight          pango_font_description_get_weight        (const PangoFontDescription *desc);
#define pango_font_description_set_stretch pango_font_desc_set_stretch
void                 pango_font_description_set_stretch       (PangoFontDescription *desc,
							       PangoStretch          stretch);
#define pango_font_description_get_stretch pango_font_desc_get_stretch
PangoStretch         pango_font_description_get_stretch       (const PangoFontDescription *desc);
#define pango_font_description_set_size pango_font_descript_set_size
void                 pango_font_description_set_size          (PangoFontDescription *desc,
							       gint                  size);
#define pango_font_description_get_size pango_font_descript_get_size
gint                 pango_font_description_get_size          (const PangoFontDescription *desc);
#define pango_font_description_set_absolute_size pango_font_desc_set_abs_size
void                 pango_font_description_set_absolute_size (PangoFontDescription *desc,
							       double                size);
#define pango_font_description_get_size_is_absolute pango_font_desc_get_siz_is_abs
gboolean             pango_font_description_get_size_is_absolute (const PangoFontDescription *desc);

#define pango_font_description_get_set_fields pango_font_desc_get_set_fields
PangoFontMask pango_font_description_get_set_fields (const PangoFontDescription *desc);
#define pango_font_description_unset_fields pango_font_desc_unset_fields
...
#define pango_font_description_merge_static pango_font_desc_merge_static
void pango_font_description_merge_static (PangoFontDescription       *desc,
					  const PangoFontDescription *desc_to_merge,
					  gboolean                    replace_existing);

#define pango_font_description_better_match pango_font_desc_better_match
gboolean pango_font_description_better_match (const PangoFontDescription *desc,
					      const PangoFontDescription *old_match,
					      const PangoFontDescription *new_match);

#define pango_font_description_from_string pango_font_desc_from_string
PangoFontDescription *pango_font_description_from_string (const char                  *str);
#define pango_font_description_to_string pango_font_desc_to_string
char *                pango_font_description_to_string   (const PangoFontDescription  *desc);
#define pango_font_description_to_filename pango_font_desc_to_filename
...
#define pango_font_metrics_get_approximate_char_width pango_ft_met_get_appr_char_wid
int               pango_font_metrics_get_approximate_char_width  (PangoFontMetrics *metrics);
#define pango_font_metrics_get_approximate_digit_width pan_font_met_get_appr_digit_wid
int               pango_font_metrics_get_approximate_digit_width (PangoFontMetrics *metrics);
#define pango_font_metrics_get_underline_position pango_font_met_get_ul_pos
int               pango_font_metrics_get_underline_position      (PangoFontMetrics *metrics);
#define pango_font_metrics_get_underline_thickness pan_font_met_get_ul_thickness
int               pango_font_metrics_get_underline_thickness     (PangoFontMetrics *metrics);
#define pango_font_metrics_get_strikethrough_position pango_ft_met_get_strithru_pos
int               pango_font_metrics_get_strikethrough_position  (PangoFontMetrics *metrics);
#define pango_font_metrics_get_strikethrough_thickness pan_ft_met_get_strikthru_thick
