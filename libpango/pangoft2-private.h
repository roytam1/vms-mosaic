...
#define _pango_ft2_font_get_cache_glyph_data _pan_ft2_ft_get_cach_glyph_dat
void *_pango_ft2_font_get_cache_glyph_data    (PangoFont      *font,
					       int             glyph_index);
#define _pango_ft2_font_set_cache_glyph_data _pan_ft2_ft_set_cach_glyph_dat
void  _pango_ft2_font_set_cache_glyph_data    (PangoFont      *font,
					       int             glyph_index,
					       void           *cached_glyph);
#define _pango_ft2_font_set_glyph_cache_destroy _pan_ft2_ft_set_glyph_cach_dest
...
#define _pango_ft2_font_map_get_renderer _pan_ft2_font_map_get_renderer
