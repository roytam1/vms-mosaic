...
void           _pango_fc_font_map_remove          (PangoFcFontMap *fcfontmap,
						   PangoFcFont    *fcfont);
#define _pango_fc_font_map_get_coverage _pango_fc_font_map_get_cover
PangoCoverage *_pango_fc_font_map_get_coverage    (PangoFcFontMap *fcfontmap,
						   PangoFcFont    *fcfont);
#define _pango_fc_font_map_fc_to_coverage _pango_fc_font_map_fc_to_cover
...
#define pango_fc_font_create_metrics_for_context pan_fc_font_creat_met_for_cont
