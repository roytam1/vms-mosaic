...
#define pango_fc_font_map_create_context pango_fc_font_map_creat_context
...
#define pango_fc_font_map_add_decoder_find_func pan_fc_ft_map_add_deco_find_fun
void pango_fc_font_map_add_decoder_find_func (PangoFcFontMap        *fcfontmap,
					      PangoFcDecoderFindFunc findfunc,
					      gpointer               user_data,
					      GDestroyNotify         dnotify);

#define pango_fc_font_description_from_pattern pango_fc_font_desc_from_pattern
