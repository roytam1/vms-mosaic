...
void pango_ft2_render_layout_line          (FT_Bitmap        *bitmap,
					    ...
					    int               x,
					    int               y);
#define pango_ft2_render_layout_line_subpixel pango_ft2_rend_lay_line_subpix
...
void pango_ft2_render_layout               (FT_Bitmap        *bitmap,
					    ...
					    int               x,
					    int               y);
#define pango_ft2_render_layout_subpixel pango_ft2_render_layout_subpix
...
#define pango_ft2_font_map_set_resolution pango_ft2_font_map_set_resolut
void          pango_ft2_font_map_set_resolution         (PangoFT2FontMap        *fontmap,
							 double                  dpi_x,
							 double                  dpi_y);
#define pango_ft2_font_map_set_default_substitute pango_ft2_font_map_set_def_sub
void          pango_ft2_font_map_set_default_substitute (PangoFT2FontMap        *fontmap,
							 PangoFT2SubstituteFunc  func,
							 gpointer                data,
							 GDestroyNotify          notify);
#define pango_ft2_font_map_substitute_changed pango_ft2_font_map_sub_changed
void          pango_ft2_font_map_substitute_changed     (PangoFT2FontMap         *fontmap);
#define pango_ft2_font_map_create_context pango_ft2_font_map_create_cont
