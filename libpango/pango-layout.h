...
#define pango_layout_set_markup_with_accel pango_lay_set_markup_with_accel
...
#define pango_layout_set_font_description pango_layout_set_font_descript
void           pango_layout_set_font_description (PangoLayout                *layout,
						  const PangoFontDescription *desc);

#define pango_layout_get_font_description pango_layout_get_font_descript
...
#define pango_layout_set_single_paragraph_mode pango_lay_set_single_para_mode
void           pango_layout_set_single_paragraph_mode (PangoLayout                *layout,
                                                       gboolean                    setting);
#define pango_layout_get_single_paragraph_mode pango_lay_get_single_para_mode
...
#define pango_layout_move_cursor_visually pango_lay_move_cursor_visually
...
void     pango_layout_line_get_extents  (PangoLayoutLine  *line,
					 PangoRectangle   *ink_rect,
					 PangoRectangle   *logical_rect);
#define pango_layout_line_get_pixel_extents pango_layout_line_get_pixel_ext
...
#define pango_layout_iter_get_char_extents pango_layout_iter_get_char_ext
void pango_layout_iter_get_char_extents    (PangoLayoutIter *iter,
                                            PangoRectangle  *logical_rect);
#define pango_layout_iter_get_cluster_extents pango_lay_iter_get_cluster_ext
void pango_layout_iter_get_cluster_extents (PangoLayoutIter *iter,
                                            PangoRectangle  *ink_rect,
                                            PangoRectangle  *logical_rect);
#define pango_layout_iter_get_run_extents pango_layout_iter_get_run_ext
void pango_layout_iter_get_run_extents     (PangoLayoutIter *iter,
                                            PangoRectangle  *ink_rect,
                                            PangoRectangle  *logical_rect);
#define pango_layout_iter_get_line_extents pango_lay_iter_get_line_ext
 ...
 */
#define pango_layout_iter_get_line_yrange pango_lay_iter_get_line_yrange
void pango_layout_iter_get_line_yrange     (PangoLayoutIter *iter,
                                            int             *y0_,
                                            int             *y1_);
#define pango_layout_iter_get_layout_extents pango_layout_iter_get_lay_ext
