...
gpointer        g_param_spec_steal_qdata	(GParamSpec    *pspec,
						 GQuark         quark);
#define g_param_spec_get_redirect_target g_param_spec_get_redirect_targe
...
#define g_value_set_param_take_ownership g_value_set_param_take_ownershi
...
#define _g_param_type_register_static_constant _g_param_type_regist_stat_const
