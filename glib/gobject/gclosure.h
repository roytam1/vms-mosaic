...
#define g_closure_remove_finalize_notifier g_closure_remove_finalize_not
void	  g_closure_remove_finalize_notifier	(GClosure       *closure,
						 gpointer	 notify_data,
						 GClosureNotify	 notify_func);
#define g_closure_add_invalidate_notifier g_closure_add_invalidate_not
void	  g_closure_add_invalidate_notifier	(GClosure       *closure,
						 gpointer	 notify_data,
						 GClosureNotify	 notify_func);
#define g_closure_remove_invalidate_notifier g_closure_remove_invalidate_not
