...
.IFDEF NOWAIS
default : libwww2 libXmx libhtmlw libjpeg libnut libpng zlib \
	  libliteclue libvms src
.ELSE
default : libWAIS libwww2 libXmx libhtmlw libjpeg libnut libpng zlib \
	  libliteclue libvms src
.ENDIF
.IFDEF NOLINK
