...
#define gdk_pixbuf_animation_new_from_file gdk_pixbuf_anim_new_from_file
...
#define gdk_pixbuf_animation_is_static_image gdk_pixbuf_anim_is_static_image
gboolean            gdk_pixbuf_animation_is_static_image  (GdkPixbufAnimation *animation);
#define gdk_pixbuf_animation_get_static_image gdk_pixbuf_anim_get_static_img
GdkPixbuf          *gdk_pixbuf_animation_get_static_image (GdkPixbufAnimation *animation);

GdkPixbufAnimationIter *gdk_pixbuf_animation_get_iter                        (GdkPixbufAnimation     *animation,
                                                                              const GTimeVal         *start_time);
#define gdk_pixbuf_animation_iter_get_type gdk_pixbuf_anim_iter_get_type
GType                   gdk_pixbuf_animation_iter_get_type                   (void) G_GNUC_CONST;
#define gdk_pixbuf_animation_iter_get_delay_time gdk_pixbu_anim_iter_get_del_tim
int                     gdk_pixbuf_animation_iter_get_delay_time             (GdkPixbufAnimationIter *iter);
#define gdk_pixbuf_animation_iter_get_pixbuf gdk_pixbuf_anim_iter_get_pixbuf
GdkPixbuf              *gdk_pixbuf_animation_iter_get_pixbuf                 (GdkPixbufAnimationIter *iter);
#define gdk_pixbuf_animation_iter_on_currently_loading_frame gdk_pb_anim_iter_on_cur_lo_fra
gboolean                gdk_pixbuf_animation_iter_on_currently_loading_frame (GdkPixbufAnimationIter *iter);
#define gdk_pixbuf_animation_iter_advance gdk_pixbuf_animation_iter_advan
