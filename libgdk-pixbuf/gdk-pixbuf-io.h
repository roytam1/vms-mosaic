...
#define gdk_pixbuf_format_get_description gdk_pixbuf_format_get_descript
gchar     *gdk_pixbuf_format_get_description (GdkPixbufFormat *format);
#define gdk_pixbuf_format_get_mime_types gdk_pixbuf_format_get_mime_type
gchar    **gdk_pixbuf_format_get_mime_types  (GdkPixbufFormat *format);
#define gdk_pixbuf_format_get_extensions gdk_pixbuf_format_get_extension
