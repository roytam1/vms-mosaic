...
int pathEval(char *, char *);
mo_status mo_edit_source(mo_window *);
mo_status mo_search_window(mo_window *, char *, int, int, int);
mo_status mo_save_window(mo_window *, char *, mo_format_token);
mo_status mo_print_window(mo_window *, mo_format_token, char *);
