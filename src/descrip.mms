...
!
! Copyright (C) 2003, 2005, 2006 - The VMS Mosaic Project
!
...
.IFDEF PATHWAY
	@ Define DECC$User_Include 'F$Environment("Default")',LIBWWW2, -
			LIBHTMLW,LIBXMX,LIBJPEG,LIBPNG,ZLIB,LIBLITECLUE
.ELSE
	@ Define DECC$User_Include 'F$Environment("Default")',LIBWWW2, -
			LIBHTMLW,LIBXMX,LIBJPEG,LIBPNG,ZLIB,LIBLITECLUE,SYS
...
.IFDEF PATHWAY
	@ Define C$Include 'F$Environment("Default")',LIBWWW2, -
			LIBHTMLW,LIBXMX,LIBJPEG,LIBPNG,LIBLITECLUE,ZLIB
.ELSE
.IFDEF VAXC
	@ Define C$Include 'F$Environment("Default")',LIBWWW2, -
			LIBHTMLW,LIBXMX,LIBJPEG,LIBPNG,ZLIB,LIBLITECLUE,SYS
...
PROG_LIBS = [-.LIBHTMLW.$(WORK)]LIBHTMLW.OLB [-.LIBXMX.$(WORK)]LIBXMX.OLB \
  ...
  [-.LIBPNG.ZLIB.$(WORK)]LIBZ.OLB [-.LIBLITECLUE.$(WORK)]LIBLITECLUE.OLB \
  [-.LIBVMS.$(WORK)]LIBVMS.OLB $(LIBWAIS)
...
OBJS = Odir:accept.obj,Odir:annotate.obj,Odir:audan.obj,Odir:bla.obj,\
 ...
 Odir:hotlist.obj,Odir:img.obj,Odir:mailto.obj,Odir:main.obj,\
 Odir:md5.obj,Odir:medcut.obj,Odir:mo-www.obj,\
 Odir:newsrc.obj,Odir:pan.obj,Odir:picread.obj,Odir:pixmaps.obj,\
 Odir:prefs.obj,Odir:proxy-dialogs.obj,Odir:proxy-misc.obj,\
 Odir:quantize.obj,Odir:readbmp.obj,\
 Odir:readjpeg.obj,Odir:readpng.obj,Odir:support.obj,Odir:xpmhash.obj,\
 Odir:xpmread.obj
...
$(WDIR)libraries.opt :
	...
	@ write libraries_file "[-.LIBPNG.ZLIB.$(WORK)]LIBZ.OLB/Lib"
...
Odir:accept.obj :        accept.c accept.h port.h [-.libwww2]tcp.h [-]config.h\
			 [-]config_$(WORK).h
...
Odir:audan.obj :         audan.c audan.h gui.h mo-www.h mosaic.h pan.h\
			 ...
			 [-]config_$(WORK).h
Odir:bla.obj :           bla.c cci.h cciserver.h port.h\
...
Odir:ccibindings.obj :   ccibindings.c annotate.h cci.h ccibindings.h\
                         ...
                         pan.h port.h prefs.h prefs_defs.h toolbar.h\
...
Odir:ccibindings2.obj :  ccibindings2.c cci.h ccibindings2.h cciserver.h\
                         gui.h mosaic.h port.h prefs.h prefs_defs.h\
...
Odir:cciserver.obj :     cciserver.c accept.h cci.h ccibindings2.h cciserver.h\
                         port.h prefs.h prefs_defs.h toolbar.h\
			 [-.libnut]str-tools.h\
                         [-.libxmx]xmx.h [-]config.h [-]config_$(WORK).h
...
Odir:gui-documents.obj : gui-documents.c annotate.h cci.h ccibindings.h\
			 ...
			 gui-extras.h gui.h\
                         history.h mo-www.h mosaic.h port.h prefs.h\
                         prefs_defs.h toolbar.h [-.libhtmlw]html.h\
			 [-.libhtmlw]htmlp.h [-.libnut]str-tools.h\
			 [-.libwww2]htmime.h [-.libxmx]xmx.h [-]config.h\
			 [-]config_$(WORK).h
...
Odir:gui-ftp.obj :       gui-ftp.c gui-ftp.h gui-popup.h gui.h hotlist.h\
                         ...
                         [-.libhtmlw]html.h [-.libnut]system.h\
			 [-.libnut]str-tools.h [-.libxmx]xmx.h\
			 [-.libwww2]htftp.h [-]config.h [-]config_$(WORK).h
Odir:gui-menubar.obj :   gui-menubar.c annotate.h cci.h ccibindings.h\
			 ...
			 gui-news.h gui-popup.h gui.h\
                         ...
                         pan.h port.h prefs.h prefs_defs.h proxy.h toolbar.h\
...
Odir:gui.obj :           gui.c cci.h comment.h gui-documents.h gui-menubar.h\
			 ...
			 pan.h pixmaps.h port.h prefs.h prefs_defs.h proxy.h\
			 ...
			 [-.libwww2]htcookie.h [-.libwww2]http.h\
			 [-.libxmx]xmx.h [-.libhtmlw]htmlp.h\
			 [-]config.h [-]config_$(WORK).h\
...
Odir:img.obj :           img.c img.h cci.h globalhist.h gui.h img.h mo-www.h\
			 mosaic.h picread.h port.h prefs.h\
			 prefs_defs.h toolbar.h\
                         gifread.h [-.libhtmlw]html.h [-.libhtmlw]htmlp.h\
			 [-.libnut]str-tools.h [-.libxmx]xmx.h [-]config.h\
			 [-]config_$(WORK).h
Odir:mailto.obj :        mailto.c mailto.h gui.h mosaic.h prefs.h prefs_defs.h\
...
Odir:main.obj :          main.c main.h cci.h ccibindings2.h cciserver.h\
			 child.h globalhist.h gui.h hotlist.h mosaic.h\
                         newsrc.h pan.h port.h prefs.h prefs_defs.h toolbar.h\
...
Odir:mo-www.obj :        mo-www.c gui-dialogs.h gui.h mo-www.h\
                         ...
                         [-.libwww2]htlist.h [-.libwww2]html.h\
                         [-.libwww2]htmldtd.h [-.libwww2]htmime.h\
			 [-.libwww2]htparse.h\
                         [-.libwww2]htstream.h [-.libwww2]htstring.h\
...
Odir:picread.obj :       picread.c gifread.h mosaic.h picread.h prefs.h\
                         prefs_defs.h readbmp.h\
			 readjpeg.h readpng.h toolbar.h xpmread.h\
                         [-.libpng.zlib]zconf.h [-.libpng.zlib]zlib.h\
                         [-.libpng]png.h [-.libpng]pngconf.h [-.libxmx]xmx.h\
                         [-]config.h [-]config_$(WORK).h
Odir:pixmaps.obj :       pixmaps.c mosaic.h pixmaps.h prefs.h\
                         prefs_defs.h toolbar.h xpm.h xpmread.h [-.libxmx]xmx.h\
...
Odir:readpng.obj :       readpng.c mosaic.h prefs.h prefs_defs.h readpng.h\
                         quantize.h toolbar.h [-.libpng.zlib]zconf.h\
			 [-.libpng.zlib]zlib.h\
                         [-.libpng]png.h [-.libpng]pngconf.h [-.libxmx]xmx.h\
                         [-]config.h [-]config_$(WORK).h
Odir:support.obj :       support.c cci.h port.h [-]config.h [-]config_$(WORK).h
