 ...
 */
#define LIBXML_DOTTED_VERSION "2.4.27"
 ...
 */
#define LIBXML_VERSION_STRING "20427"
 ...
 */
#define LIBXML_TEST_VERSION xmlCheckVersion(20427);
 ...
 */
#if !defined(VMS) || (defined(__VMS_VER) && (__VMS_VER >= 60200000))
