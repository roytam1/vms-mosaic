...
$  Then cc_opts = "/FLOAT=IEEE/IEEE_MODE=DENORM_RESULTS"
$  Else If Platform .EQS. "IA64"
$   Then cc_opts = "/FLOAT=IEEE/IEEE_MODE=DENORM_RESULTS"
$   Else cc_opts = "/VAXC/G_FLOAT"
$   Endif
$  Endif
$!
...
$!
$! these programs are built as ordinary modules into XML_LIBDIR:LIBXML.OLB.
$! Here they are built a second time with /DEFINE=(STANDALONE) in which case
$! a main() is also compiled into the module
$ 
$ lib_command	= ""
$ link_command	= "LINK"
$!
